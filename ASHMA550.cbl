...
00038  01  MOUT-REC.
00039  COPY ASREASRD02.
00040      SKIP2
00041  COPY FDVETMST01.
00042      SKIP2
00043  COPY FDVSAMHMST.
00044      SKIP2
00045  FD  PRNTFILE
...
00463      INSPECT P-PROP REPLACING ALL ',' BY '-'.
00464      MOVE    MSG (MSG-NO) TO P-MSG.
00465      WRITE   PRNT-REC FROM P-LINE AFTER ADVANCING 2.
...
00473      WRITE   PRNT-REC FROM H-1 AFTER PAGE.
00474      WRITE   PRNT-REC FROM H-2 AFTER ADVANCING 2.
00475      WRITE   PRNT-REC FROM H-3 AFTER ADVANCING 2.
