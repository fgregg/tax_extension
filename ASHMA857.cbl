...
00315  77  NULL-CLASS-TAB         PIC X(24) VALUE NULLS.
00316
00317
00318  01  FILLER.
...
00895         DISPLAY 'PARAM CURRENT PROCESS YEAR NOT VALID ' PR-CURR-YR
00896         MOVE 16 TO RETURN-CODE
00897      ELSE
00898         COMPUTE WS-PROC-YR = PR-CURR-N.
00899      IF PR-EQ-FCTR NOT NUMERIC OR PR-EQ-FCTR EQUAL ZEROES
00900         DISPLAY 'PARAM EQUALIZATION FACTOR NOT VALID  ' PR-EQ-FCTR
...
02572      DISPLAY 'THE NUMBER OF SENSITIVE SEGMENTS ARE    ' PI-SEN-SEG
